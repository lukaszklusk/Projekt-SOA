...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://encode.kis.edu.agh.pl/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://encode.kis.edu.agh.pl/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://encode.kis.edu.agh.pl/", "upload");
    private final static QName _UploadResponse_QNAME = new QName("http://encode.kis.edu.agh.pl/", "uploadResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://encode.kis.edu.agh.pl/", name = "download")
     ...
     */
    @XmlElementDecl(namespace = "http://encode.kis.edu.agh.pl/", name = "downloadResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://encode.kis.edu.agh.pl/", name = "upload")
     ...
     */
    @XmlElementDecl(namespace = "http://encode.kis.edu.agh.pl/", name = "uploadResponse")
